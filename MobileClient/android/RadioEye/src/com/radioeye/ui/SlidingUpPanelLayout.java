...
public class SlidingUpPanelLayout extends ViewGroup {
	...
	private boolean expandPanel(View pane, int initialVelocity,
		...
		return ismFirstLayout()
				|| smoothSlideTo(mSlideOffset, initialVelocity, callback);
	...
	private boolean collapsePanel(View pane, int initialVelocity,
		...
		return ismFirstLayout()
				|| smoothSlideTo(0.0f, initialVelocity, callback);
	}
	 ...
	 */
	public boolean collapsePanel(Panelcallback callback) {
		if (mSlideState == SlideState.HIDDEN
				|| mSlideState == SlideState.COLLAPSED)
			return false;
		return collapsePanel(mSlideableView, 0, callback);
	}
	...
	public boolean expandPanel(Panelcallback callback) {
		return expandPanel(1.0f, callback);
	}
	 ...
	 *         of expanding
	 */
	public boolean expandPanel(float mSlideOffset, Panelcallback callback) {
		...
		return expandPanel(mSlideableView, 0, mSlideOffset, callback);
	}
	...
	public void hidePanel() {
		...
		int newTop = computePanelTopPosition(0.0f)
				+ (mIsSlidingUp ? +mPanelHeight : -mPanelHeight);
		smoothSlideTo(computeSlideOffset(newTop), 0, null);
	}
